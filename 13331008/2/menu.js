window.onload = function() {
	...
	var ev=document.createEvent('HTMLEvents'); // 创建判断求和大气泡是否应该激活的事件
	ev.initEvent('sum_circle_active', true, true);
...
function auto1(circles, ev) { // 仿真机器人
	return function() {
		get_number(circles, 4, ev, function() {
			get_number(circles, 3, ev, function() {
				get_number(circles, 2, ev, function() {
					get_number(circles, 1, ev, function() {
						get_number(circles, 0, ev, get_sum			
						)();
					})();
				})();
			})();
